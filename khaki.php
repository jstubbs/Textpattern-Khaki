...
class khaki_theme extends classic_theme
{
	function html_head()
	{
		$js = <<<SF
...
SF;
	...
	function header()
	{
		...
		$out[] = '<div id="header"><span id="branding">'.$site_name.'</span>';
		$out[] = '<ul id="navpop">'.navPop(1).'</ul></div>';
	...
	function manifest()
	{
		...
		return array(
			'author' 		=> 'TXP Builders',
			'author_uri' 	=> 'http://txpbuilders.com/',
			'version' 		=> '2.0',
			'description' 	=> 'Khaki Admin Theme',
		);
	}
}
?>
